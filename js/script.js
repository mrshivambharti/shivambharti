...
document.getElementById("emailForm").addEventListener("submit", function (event) {
    ...
    if (isMobile) {
        ...
        const composeUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=${encodeURIComponent('shivambhartiofficial@gmail.com')}&su=${encodeURIComponent(subject)}&body=${encodeURIComponent(message + "\n\n\n\nName: " + fullName + "\nEmail: " + emailAddress + "\nPhone: " + mobileNumber)}`;
